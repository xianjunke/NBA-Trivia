...
public class QuestionsP1 extends Activity {
	protected void onCreate(Bundle savedInstanceState) {
	super.onCreate(savedInstanceState);
	setContentView(R.layout.questions_p1);
	...
	Button confirm = (Button) findViewById(R.id.button1);
		...
		public void onClick(View v) {
			if(one.isChecked()){
	    			...
	    			result.setText("Correct! Of course it was."); 	}
	...
	Button nextPg = (Button) findViewById(R.id.button2);
		...
		public void onClick(View v) {
			...
			startActivity(new Intent(QuestionsP1.this, QuestionsP2.class));
			}
		}); 
	}	
}
