...
public class QuestionsP8 extends Activity {
	protected void onCreate(Bundle savedInstanceState) {
	super.onCreate(savedInstanceState);
	setContentView(R.layout.questions_p8);
	...
	Button confirm = (Button) findViewById(R.id.button1);
		...
		public void onClick(View v) {
			...
			if(one.isChecked()){
	    			...
	    			counter++;
	    			result.setText("Correct! It was absolute linsanity."); }
	...
	Button nextPg = (Button) findViewById(R.id.button2);
		...
		public void onClick(View v) {
			...
			startActivity(new Intent(QuestionsP8.this, QuestionsP9.class));
			}
		}); 
	}	
}